...
for i in range(len(
        Alphabet)):  # створюємо словники: перший - якій букві відповідає який номер, другий - навпаки, якому номеру відповідає яка буква
...
def decrypt(text,
            key):  # розкодування. працює аналогічно, тілки від номеру букви закодованого слова віднімаємо номер відповідної букви ключа
    text = text.lower()
    key = key.lower()
